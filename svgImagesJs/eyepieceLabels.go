...
func eyepieceLabel(id string, focus, units, magnification, viewAngle string) string {
	s := fmt.Sprintf(form1, id, id, id, focus, units, magnification, viewAngle)
	return s
}

func LabelsPage() {
	//   <use id="e1a" transform="translate(400, 400)  scale(7.5,7.5)" xlink:href="#k1a"></use><!-- asi 53mm -->
	eyepieceLabel("k1a", "32", "mm", "162x", "32'")
}
